...
#### Error "File not found" while executing logic function

Run `yarn command:prod application:rebuild-default-deps` command in server container to fix the issue.
