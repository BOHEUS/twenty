...
Early Access features are capabilities being tested before general release. Currently, only **Junction relations** are in Early Access. They may change based on user feedback.
</Accordion>
