...
- **Upload files**: Ability to upload files in Twenty
- **Download files**: Ability to download files from Twenty
- **Sync account**: Ability to add email and calendar accounts in Twenty
- **Manage views**: Ability to manage views in Twenty
- **Ask AI**: Ability to use AI-powered features like AI chat or AI agents in workflows
