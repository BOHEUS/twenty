...
- **AI usage analytics**: Track AI consumption across the workspace
</Accordion>
...
You can do so under `Settings → Billing`. Then click on `Switch to Pro`.
</Accordion>
...
You can do so under `Settings → Billing`. Then click on `Switch to Monthly`.
</Accordion>
...
- **AI prompts** will also consume more credits based on usage
