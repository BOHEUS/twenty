...
<Note>
Premium features (SSO, row-level permissions and AI usage analytics) are not included in the Pro plan.
</Note>

### Organization (Cloud)
For larger teams with advanced needs:
- Everything in Pro
- **Premium features**: SSO integration, row-level permissions and AI usage analytics
- Priority support
