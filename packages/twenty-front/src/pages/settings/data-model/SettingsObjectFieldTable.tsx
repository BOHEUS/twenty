    ...
    <>
      ...
      <Table>
        ...
        {isNonEmptyArray(filteredActiveItems) && (
          <TableSection title="Active" dataTestId="active-fields">
        ...
        {isNonEmptyArray(filteredDisabledItems) && (
          <TableSection
            isInitiallyExpanded={mode === 'new-field'}
            title="Inactive"
            dataTestId="inactive-fields"
          >
