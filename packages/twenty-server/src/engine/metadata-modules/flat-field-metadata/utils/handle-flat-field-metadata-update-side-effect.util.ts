...
import { recomputeSearchVectorFieldAfterSearchedFieldUpdate } from 'src/engine/metadata-modules/flat-field-metadata/utils/recompute-search-vector-field-after-searched-field-update.util';
...
export const handleFlatFieldMetadataUpdateSideEffect = ({
  ...
  const flatSearchVectorFieldToUpdate =
    recomputeSearchVectorFieldAfterSearchedFieldUpdate({
      fromFlatFieldMetadata,
      toFlatFieldMetadata,
      flatObjectMetadata,
      flatFieldMetadataMaps,
