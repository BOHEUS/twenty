...
@RegisteredInstanceCommand('2.34.0', 1787516865637)
export class AddExternalChannelIdToMessageChannelFastInstanceCommand
  implements FastInstanceCommand
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "core"."messageChannel" ADD "externalChannelId" character varying',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_MESSAGE_CHANNEL_EXTERNAL_CHANNEL_ID" ON "core"."messageChannel" ("externalChannelId") WHERE "externalChannelId" IS NOT NULL',
    );
    await queryRunner.query(
      'ALTER TYPE "core"."messageChannel_type_enum" RENAME TO "messageChannel_type_enum_old"',
    );
    await queryRunner.query(
      'CREATE TYPE "core"."messageChannel_type_enum" AS ENUM(\'EMAIL\', \'SMS\', \'EMAIL_GROUP\', \'CHAT\')',
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'DROP INDEX "core"."IDX_MESSAGE_CHANNEL_EXTERNAL_CHANNEL_ID"',
    );
    await queryRunner.query(
      'ALTER TABLE "core"."messageChannel" DROP COLUMN "externalChannelId"',
    );
  }
}
