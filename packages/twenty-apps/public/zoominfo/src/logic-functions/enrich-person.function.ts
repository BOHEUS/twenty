...
export default defineLogicFunction({
  universalIdentifier:
    ZOOMINFO_LOGIC_FUNCTION_CONSTANTS.enrichPerson.universalIdentifier,
  name: 'enrich-person',
  description:
    'Enrich a single Person record with ZoomInfo contact data (direct dial, job function, management level, employer, etc.) given its record id.',
  timeoutSeconds: 60,
  handler,
    ...
    inputSchema: [
      {
        ...
        properties: {
          ...
          minAccuracyScore: {
            type: 'number',
            label: 'Minimum accuracy score (0-100)',
          },
        },
      },
    ],
