...
export default defineLogicFunction({
  universalIdentifier:
    ZOOMINFO_LOGIC_FUNCTION_CONSTANTS.enrichCompany.universalIdentifier,
  name: 'enrich-company',
  description:
    'Enrich a single Company record with ZoomInfo firmographics (revenue, employee count, industries, hierarchy, funding, etc.) given its record id.',
  timeoutSeconds: 60,
  handler,
