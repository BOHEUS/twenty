...
export default defineLogicFunction({
  universalIdentifier:
    ZOOMINFO_LOGIC_FUNCTION_CONSTANTS.enrichPeople.universalIdentifier,
  name: 'enrich-people',
  description: 'Enrich one or more Person records with ZoomInfo contact data',
  timeoutSeconds: 300,
  handler,
  httpRouteTriggerSettings: {
    path: ZOOMINFO_LOGIC_FUNCTION_CONSTANTS.enrichPeople.path,
    httpMethod: 'POST',
    isAuthRequired: true,
  },
