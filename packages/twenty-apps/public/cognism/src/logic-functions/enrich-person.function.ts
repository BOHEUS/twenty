...
export default defineLogicFunction({
  universalIdentifier:
    COGNISM_LOGIC_FUNCTION_CONSTANTS.enrichPerson.universalIdentifier,
  name: 'enrich-person',
  description:
    'Enrich a single Person record with Cognism data (job, location, social profiles, etc.) given its record id.',
  timeoutSeconds: 60,
  handler,
