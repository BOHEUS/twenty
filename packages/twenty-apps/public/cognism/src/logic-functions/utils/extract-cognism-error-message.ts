import { isArray, isNonEmptyString, isObject, isString } from '@sniptt/guards';
...
export const extractCognismErrorMessage = ({
  json,
  httpStatus,
}: {
  ...
  return `Cognism request failed (HTTP ${httpStatus}).`;
};
