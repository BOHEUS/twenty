...
export default defineLogicFunction({
  ...
  name: 'enrich-people',
  description: 'Enrich one or more Person records with Crustdata data',
  timeoutSeconds: 300,
  handler,
    ...
    inputSchema: [
      {
        ...
        properties: {
          ...
          enrichContactData: {
            type: 'boolean',
            label: 'Also fetch emails and phone numbers (billed separately)',
          },
        },
      },
    ],
    outputSchema: [
      {
        ...
        properties: {
          ...
          redacted: { type: 'number', label: 'Redacted' },
