// E.164 calling codes, longest first so a prefix match never stops at a shorter shared code
// (for example +1 before +1242). Apps cannot depend on libphonenumber, and this is enough to split
// the calling code off a number Crustdata already returns in E.164.
export const PHONE_CALLING_CODES: readonly string[] = [
