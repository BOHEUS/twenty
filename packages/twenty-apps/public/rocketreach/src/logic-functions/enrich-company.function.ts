...
export default defineLogicFunction({
  universalIdentifier:
    ROCKETREACH_LOGIC_FUNCTION_CONSTANTS.enrichCompany.universalIdentifier,
  name: 'enrich-company',
  description:
    'Enrich a single Company record with RocketReach firmographic data given its record id.',
  timeoutSeconds: 60,
  handler,
