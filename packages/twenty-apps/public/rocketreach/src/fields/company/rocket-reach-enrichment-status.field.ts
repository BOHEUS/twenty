...
export default defineField({
  universalIdentifier:
    ROCKETREACH_FIELD_UNIVERSAL_IDENTIFIERS.company.rocketReachEnrichmentStatus,
  ...
  options: buildSelectOptions({
    ...
    ids: ROCKETREACH_SELECT_OPTION_UNIVERSAL_IDENTIFIERS.companyEnrichmentStatus,
  }),
});
