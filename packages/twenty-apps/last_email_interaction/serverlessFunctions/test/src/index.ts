...
const TWENTY_URL = `${process.env.TWENTY_API_URL}/rest`;
...
export const main = async (params: {properties: Record<string, any>, recordId: string, userId: string}): Promise<object> => {
